...
import 'package:mecamovil/services/auth_google.dart';
      ...
      child: Column(
        children: [
          ...
          FilledButton.tonalIcon(
            style: FilledButton.styleFrom(backgroundColor: const Color.fromRGBO(88, 113, 179, 1)),
            onPressed: ()async{
              try{
              ...
              on FirebaseAuthException catch(error){ 
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(error.message??"Algo salio mal"))
                );
              }
              catch(error){
                print(error);
